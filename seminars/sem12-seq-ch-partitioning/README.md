...
пользователей). Синяя кривая обозначает фактические данные, а восемь кривых
`h{host_number}` – значение метрики на данных каждого хоста. Что произошло после
12.03.2024 (обозначено вертикальной красной прямой)?
