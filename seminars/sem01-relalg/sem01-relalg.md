...
<aside>
<img src="/icons/database_red.svg" alt="/icons/database_red.svg" width="40px" /> База данных = набор данных + правила их хранения + правила их использования.
...
<aside>
<img src="/icons/database_orange.svg" alt="/icons/database_orange.svg" width="40px" /> Результат любой из операций выше – отношение. Это значит, что в результирующей таблице мы получаем только уникальные кортежи даже если “наивное” выполнение операции приводит к дублированию строк.
