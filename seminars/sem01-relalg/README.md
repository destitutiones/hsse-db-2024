...
**Естественное соединение** двух отношений $R_1$ и $R_2$ называется отношение, в
...
$$T[Level = \text{'синий'}][Length > 2000][Name, Length, Resort]$$
...
$$T[Coeff] := T[HeightDiff] / T[Length] \text{\quad // примечание: это "псевдокод", Э.Кодд нас бы по голове не погладил.}$$
$$T[Level = \text{'зеленый'}][Coeff < 0.1][Name, Coeff, Resort]$$
